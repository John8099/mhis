            ...
            <div class="form-group">
              ...
              <div class="form-group row">
                <div class="form-group col-md-4">
                  ...
                  <label>1st visit (1st trimester)</label>
                  <input type="number" class="form-control mb-2" id="iodine_1st_tri_num" name="edit_iodine_1st_tri_num" placeholder="Number of capsules" value="<?php echo $row['iodTablet'] ?>" readonly>
