                            ...
                            <tbody>
                                <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="rhu_patient-view?id=<?php echo $row['patientID']; ?>" class="btn btn-primary">View</a>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            </tbody>
                                ...
                                <ul class="pagination">
                                    ...
                                    for ($page = 1; $page <= $total_pages; $page++):
                                        ...
                                        <li class="page-item <?php echo $active_class; ?>">
                                            <a class="page-link" href="rhu_patient-records?page=<?php echo $page; ?>&search_query=<?php echo urlencode($search_query); ?>&status_filter=<?php echo $status_filter; ?>">
                                                <?php echo $page; ?>
                                            </a>
                                        </li>
                                    <?php endfor; ?>
