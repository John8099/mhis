...
if ($selectedBarangay) {
  $patientQuery = "SELECT * FROM patient WHERE barangayID = '$selectedBarangay' AND patientID NOT IN(SELECT p.patientID FROM `pre-natal_sched` p) ORDER BY patientFname ASC";
