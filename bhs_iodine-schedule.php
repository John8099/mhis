...
if (isset($selectedPatientID)) {
    $iodineQuery = "SELECT p.*, cal.iodNum, cal.iodDate
            FROM patient p
                    ...
                    <form action="bhs-functions.php" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" class="form-control" name="checkup_num" id="checkup_num" value="<?php echo htmlspecialchars($iodineRow['iodNum'] ?? '0'); ?>" readonly>
                            </div>
                        </div>
