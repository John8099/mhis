...
if ($selectedBarangay) {
  $patientQuery = "SELECT * FROM patient WHERE barangayID = '$selectedBarangay'  AND patientID NOT IN(SELECT i.patientID FROM iodine_sched i) ORDER BY patientFname ASC";
